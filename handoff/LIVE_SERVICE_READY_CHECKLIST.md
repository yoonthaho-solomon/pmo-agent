...
- `handoff/AI_PRIORITY_DISPATCH_ACCEPTANCE_TEST.md`: 개발 구현 후 정상 동작 여부를 확인할 검수 기준.
- `handoff/AI_PRIORITY_DISPATCH_DEV_MEETING_AGENDA.md`: 기존 배차로직에 AI 정렬을 끼울 위치를 찾기 위한 개발자 회의 질문지.
